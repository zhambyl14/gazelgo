...
/// ұсыныс батырмасы) ӘДЕЙІ ЖОҚ — оның орнына бот (0054, `support_bot`
/// баптауы қосулы болса) пайдаланушыға ӨЗІ ТІКЕЛЕЙ жауап жазады, модератор
/// ештеңе баспайды. Бот жауабы осында, кәдімгі хабарлама ретінде көрінеді.
