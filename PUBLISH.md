...
3. Модератор → **Баптаулар** → «Мәжбүрлі жаңарту» бөлімінде **сол
   платформаның** минималды build нөмірін жаңа мәнге көтеріңіз — өрістер
   **ЖЕКЕ**: «Android минималды build» және «iOS минималды build» (мыс.
   Android дүкенде шықса — тек Android өрісін `2` қылу). Play/App Store
   сілтемелерін толтырыңыз (алғаш рет — 1-бөлімге қараңыз), «Сақтау».
4. Содан кейін сол платформада build нөмірі осыдан төмен құрылғыда
   қосымша ашылмайды — тек «Жаңарту» экраны, дүкенге апаратын батырмамен.

**Ескерту (маңызды)**: Android мен iOS дүкенге әр уақытта жарияланады
(App Store шолуы Play-ден баяу). Сондықтан **әр платформаның санын тек
сол дүкенде жарияланғаннан кейін** көтеріңіз. iOS санын App Store-да
шықпай тұрып көтерсеңіз — iPhone қолданушылары ең соңғы қолжетімді
нұсқада отырса да «Жаңарту» экранында бұғатталып қалады (бұрын осындай
баг болған, енді өрістер бөлек — 2026-07-17 түзетілді). Минималды build =
`0` болса — сол платформада тексеру толық өшеді (әдепкі күй).
